# b27dbdfdaafdef52  ### weather underground API key
...
date_time = parsed_json['current_observation']['observation_time']
...
condition_url = parsed_json['current_observation']['icon_url']
temp_f = parsed_json['current_observation']['temp_f']
heat_index_f = parsed_json['current_observation']['heat_index_f']
wind_chill_f = parsed_json['current_observation']['windchill_f']
...
print("Current display location is %s" % disp_location)
print("Nearby weather station is %s" % list_location)
f.close()
...
for x in range(forecast_periods):
  ...
  w_fcast.append(
    {'w_date': w_date, 'w_conditions': w_conditions, 'w_conditions_url': w_conditions_url,
     ...
     'w_wind_speed': w_wind_speed, 'w_avehumidity': w_avehumidity})
...
pp.pprint(w_fcast)
print(w_fcast[0]['w_date'])

# print(w_date)
# print(w_conditions)
# print(w_conditions_gif)
# print(w_wind_dir)
# print(w_wind_speed)
# print(w_avehumidity)
# print(w_high_temp)
...
# pp.pprint(my_json)
#
# # {   'forecast': {   'simpleforecast': {   'forecastday': [   {   'avehumidity': 72,
#
# humid = my_json['forecast']['simpleforecast']['forecastday'][0]['icon']
#
# print(humid)